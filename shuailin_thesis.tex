...
% graduate setup
\documentclass[master]{shtthesis}    %[, anonymous] 
\shtsetup{
  degree-name = {工学硕士},
  degree-name* = {Master~of~Science~in~Engineering},
%   secret-level = {白给},
  title = {基于弱标签和噪声标签的医学图像语义分割},
  title* = {Semantic Segmentation of Medical Images Based on \\ Weak Labels and Noisy Labels}, %Weakly Supervised Semantic Segmentation for Medical Images}
  keywords = {语义分割，弱监督学习，形状先验},  %，自学习方法，基于噪声标签的学习
  keywords* = {Semantic Segmentation, Weakly Supervised Learning, Shape Prior}, %, Self-taught Learning, Learning with Noisy Labels
  author = {李帅霖},
  author* = {Li~Shuailin},
